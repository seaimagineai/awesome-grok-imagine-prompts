...
### 1. Gặp lại ở bến cảng — chỉ một chuyển biến cảm xúc
...
### 2. Bưu thiếp ven biển — làm chuyển động ảnh đã lên bố cục
...
### 3. Chai thủy tinh biển — so sánh chuyển động có kiểm soát biến số
