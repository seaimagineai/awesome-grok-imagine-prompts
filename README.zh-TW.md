...
> 38 段提示詞，其中 8 個圖文範例提供 15 種語言版本。依分類瀏覽，複製完整提示詞。
...
[返回分類索引](#find-the-right-prompt) · [圖文範例速覽](#visual-index)
