...
[ดูพรอมป์ต์เพิ่มเติม (ภาษาอังกฤษ) · 62](docs/PROMPT_INDEX.md)
...
| [การเล่าเรื่องแบบภาพยนตร์ · 8](docs/PROMPT_INDEX.md#02-cinematic-storytelling) | แอ็กชัน / โรแมนติก / ระทึกขวัญ / ไซไฟ / แอนิเมชัน | ข้อความเป็นวิดีโอ / ภาพเป็นวิดีโอ / ต่อความยาววิดีโอ | [เส้นทางสีน้ำเงิน — ช็อตติดตามคนส่งของในตลาดกลางฝน](#case-blue-route) · [โปสการ์ดชายฝั่ง — ทำให้ภาพที่วางองค์ประกอบแล้วเคลื่อนไหว](#case-coastal-postcard) |
...
| [ตัวละครและบทสนทนา · 7](docs/PROMPT_INDEX.md#04-characters-and-references) | ตัวละคร / เสื้อผ้า / บทสนทนา / ฉากกลุ่ม | ภาพอ้างอิงเป็นวิดีโอ / ภาพเป็นวิดีโอ | [พบกันอีกครั้งที่ท่าเรือ — ถ่ายทอดการเปลี่ยนอารมณ์เพียงจังหวะเดียว](#case-harbor-reunion) |
| [การแปลงภาพและต่อฉาก · 6](docs/PROMPT_INDEX.md#05-editing-and-extension) | เปลี่ยนสภาพอากาศ / ลบสิ่งรบกวน / เปลี่ยนสไตล์ / ต่อฉาก | แก้ไขวิดีโอ / ต่อความยาววิดีโอ | — |
| [วัสดุและเสียงที่ชวนผ่อนคลาย · 6](docs/PROMPT_INDEX.md#07-satisfying-materials) | อัดทราย / แผ่นทองแดง / หยดน้ำ / ลายหินอ่อน | ข้อความเป็นวิดีโอ | — |
| [พื้นที่และสถาปัตยกรรม · 6](docs/PROMPT_INDEX.md#08-spaces-and-transformations) | เฟอร์นิเจอร์คลี่ออก / ลานบ้าน / ภาพตัดบ้าน | ข้อความเป็นวิดีโอ | — |
...
| [แฟชั่นและการแสดง · 6](docs/PROMPT_INDEX.md#10-fashion-and-performance) | ชายกระโปรง / ผ้าคลุม / ภาพฉายบนปกเสื้อ / ท่าเต้น | ข้อความเป็นวิดีโอ | — |
...
<a href="assets/seaimagine-coastal-postcard.webp"><img src="assets/seaimagine-coastal-postcard.webp" width="480" alt="โปสการ์ดชายฝั่ง — ทำให้ภาพที่วางองค์ประกอบแล้วเคลื่อนไหว"></a>
...
เลือกวิดีโอสินค้าขวดแก้ว บทสนทนาที่ท่าเรือ หรือโปสการ์ดเคลื่อนไหวจากด้านบน แล้วนำภาพและพรอมป์ต์ฉบับเต็มไปใช้กับ Grok Imagine 1.5 บน SeaImagine ลองเน้นพื้นผิววัสดุในช็อตสินค้า การแสดงในบทสนทนา และองค์ประกอบภาพในกราฟิกเคลื่อนไหว

[พื้นผิวสินค้า](#case-sea-glass-bottle) · [บทสนทนาตัวละคร](#case-harbor-reunion) · [เลย์เอาต์เคลื่อนไหว](#case-coastal-postcard)
...
พรอมป์ต์ภาษาอังกฤษทั้งหมด 62 แบบ: 35 แบบจากคลังต้นฉบับและ 27 แบบที่เขียนขึ้นเอง โดย 24 แบบล่าสุดได้แรงบันดาลใจจากหัวข้อบนโซเชียลมีเดียและยังไม่ได้ทดสอบสร้างวิดีโอ คำแปลไม่นับเป็นฉากใหม่
