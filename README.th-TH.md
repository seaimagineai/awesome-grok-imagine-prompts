...
| สิ่งที่อยากสร้าง | เริ่มด้วยตัวอย่างพร้อมภาพ |
| --- | --- |
...
**ดูพรอมป์ต์เพิ่มเติม (ภาษาอังกฤษ):** [โฆษณาและสินค้า](prompts/01-ads-and-products.md) · [เรื่องราวแบบภาพยนตร์](prompts/02-cinematic-storytelling.md) · [โซเชียลและไลฟ์สไตล์](prompts/03-social-ugc.md) · [ตัวละครและภาพอ้างอิง](prompts/04-characters-and-references.md) · [การแก้ไขและต่อความยาว](prompts/05-editing-and-extension.md)

[ตัวอย่างพร้อมภาพ](#featured-prompts) · [ขั้นตอนบนเว็บ](#seaimagine-browser-workflow) · [ผลงานทางการและชุมชน](#learn-from-official-and-community-examples) · [คู่มือเขียน](#writing-guide)

<a id="featured-prompts"></a>

## พรอมป์ต์พร้อมภาพที่คัดลอกและปรับใช้ได้

เลือกหัวข้อด้านล่าง บันทึกภาพเริ่มต้น แล้วคัดลอกพรอมป์ต์ฉบับเต็ม เริ่มจากหนึ่งการกระทำและหนึ่งการเคลื่อนกล้อง ภาพเป็นเพียงแนวคิด ไม่ใช่ผลลัพธ์วิดีโอที่ผ่านการตรวจสอบแล้ว
...
[เฟรมเริ่มต้น — เปิดและบันทึก](assets/rainy-market-courier-video.webp)

**การตั้งค่าภาพเป็นวิดีโอ:** 10s · 16:9 · 1080p

[ที่มา: Flaq AI](docs/ATTRIBUTION.md) · [ขั้นตอนบนเว็บ](#seaimagine-browser-workflow)
...
[เฟรมเริ่มต้น — เปิดและบันทึก](assets/pear-bakery-miniature-video.webp)

**การตั้งค่าภาพเป็นวิดีโอ:** 9s · 16:9 · 1080p
...
<a href="assets/cozy-cafe-ugc-video.webp"><img src="assets/cozy-cafe-ugc-video.webp" width="420" alt="จิบแรก — รีวิวคาเฟ่อย่างเป็นธรรมชาติ"></a>

[เฟรมเริ่มต้น — เปิดและบันทึก](assets/cozy-cafe-ugc-video.webp)

**การตั้งค่าภาพเป็นวิดีโอ:** 10s · 9:16 · 1080p
...
[เฟรมเริ่มต้น — เปิดและบันทึก](assets/coastal-salt-train-documentary.webp)

**การตั้งค่าภาพเป็นวิดีโอ:** 12s · 16:9 · 1080p
...
[เฟรมเริ่มต้น — เปิดและบันทึก](assets/citrus-fragrance-product-video.webp)

**การตั้งค่าภาพเป็นวิดีโอ:** 8s · 16:9 · 1080p
...
[คู่มือเขียน](docs/guides/th-TH.md)
