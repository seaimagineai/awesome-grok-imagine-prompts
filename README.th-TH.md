...
## เลือกฉาก คัดลอกพรอมป์ต์ แล้วเริ่มสร้างผลงาน

อยากทำหนังสั้นที่เน้นตัวละคร โปสการ์ดเคลื่อนไหว หรือช็อตสินค้าไหม? แต่ละตัวอย่างด้านล่างมีเฟรมเริ่มต้นให้บันทึก พรอมป์ต์ฉบับเต็ม และจุดที่ควรตรวจสอบ เลือกหนึ่งฉากแล้วเปลี่ยนตัวละครหรือวัตถุหลักเป็นของคุณก็เริ่มได้ ตัวอย่างเขียนตามตัวเลือกบนหน้าเว็บ SeaImagine ได้แก่ 5/10/15 วินาที และ 480p/720p ภาพประกอบเป็นเฟรมเริ่มต้นสำหรับแสดงแนวคิดที่สร้างด้วย AI และยังไม่ได้ใช้พรอมป์ต์สร้างวิดีโอเพื่อทดสอบจริง
