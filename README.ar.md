...
[تصفّح المزيد من نصوص التوجيه (بالإنجليزية) · 62](docs/PROMPT_INDEX.md)
...
| [السرد السينمائي · 8](docs/PROMPT_INDEX.md#02-cinematic-storytelling) | حركة / رومانسية / تشويق / خيال علمي / رسوم متحركة | من نص إلى فيديو / من صورة إلى فيديو / تمديد الفيديو | [المسار الأزرق: تتبّع مندوب توصيل في سوق ممطر](#case-blue-route) · [بطاقة ساحلية: حرّك صورة مخططة مسبقًا](#case-coastal-postcard) |
...
| [الشخصيات والحوار · 7](docs/PROMPT_INDEX.md#04-characters-and-references) | شخصيات / ملابس / حوار / مشاهد جماعية | من صور مرجعية إلى فيديو / من صورة إلى فيديو | [لقاء في الميناء: لحظة عاطفية واحدة](#case-harbor-reunion) |
| [التحولات البصرية والاستكمال · 6](docs/PROMPT_INDEX.md#05-editing-and-extension) | تغيير الطقس / إزالة عناصر / تغيير الأسلوب / استكمال | تحرير الفيديو / تمديد الفيديو | — |
| [الخامات والأصوات المريحة · 6](docs/PROMPT_INDEX.md#07-satisfying-materials) | ضغط الرمل / رقائق النحاس / قطرات الماء / تلوين رخامي | من نص إلى فيديو | — |
| [المساحات والعمارة · 6](docs/PROMPT_INDEX.md#08-spaces-and-transformations) | أثاث ينفتح / أفنية / مقاطع عرضية للمنازل | من نص إلى فيديو | — |
...
| [الأزياء والأداء · 6](docs/PROMPT_INDEX.md#10-fashion-and-performance) | حركة التنانير / عباءات / إسقاطات على الياقات / خطوات رقص | من نص إلى فيديو | — |
...
اختر من الأمثلة أعلاه لقطة المنتج بالقارورة الزجاجية أو الحوار في الميناء أو البطاقة البريدية المتحركة، ثم استخدم الصورة والمطالبة الكاملة في Grok Imagine 1.5 على SeaImagine. استكشف الخامات في لقطات المنتجات، والأداء في الحوار، والتكوين في الرسوم المتحركة.

[خامات المنتجات](#case-sea-glass-bottle) · [حوار الشخصيات](#case-harbor-reunion) · [تصاميم متحركة](#case-coastal-postcard)
